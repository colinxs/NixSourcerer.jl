{ pkgs ? import <nixpkgs> { } }: {
  ...
  depot = {
    "artifacts/2a0fba617ae96fd7bec0e5f0981a2cc395998f08" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/artifact/2a0fba617ae96fd7bec0e5f0981a2cc395998f08#artifact.tar.gz";
    });
    "artifacts/2e8fae88dcadc37883e31246fe7397f4f1039f88" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/artifact/2e8fae88dcadc37883e31246fe7397f4f1039f88#artifact.tar.gz";
    });
    ...
    "artifacts/75b2da9ed2ec48588460be0f3a8bb489212012e9" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/artifact/75b2da9ed2ec48588460be0f3a8bb489212012e9#artifact.tar.gz";
    });
    ...
    "artifacts/bc7df2a88972dd1ff2685e091585f5c979bfd436" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/artifact/bc7df2a88972dd1ff2685e091585f5c979bfd436#artifact.tar.gz";
    });
    ...
    "packages/Expat_jll/PhUfV" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/2e619515-83b5-522b-bb60-26c02a35a201/b3bfd02e98aedfa5cf885665493c5598c350cd2f#package.tar.gz";
    });
    ...
    "packages/Git/EnxqL" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/d7ba0133-e1db-5d97-8f8c-041e4b3a1eb2/d7bffc3fe097e9589145493c08c41297b457e5d0#package.tar.gz";
    });
    ...
    "packages/HTTP/4AvE2" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/cd3eb016-35fb-5094-929b-558a96fad6f3/c6a1fff2fd4b1da29d3dccaffb1e1001244d844e#package.tar.gz";
    });
    ...
    "packages/Libiconv_jll/tGWLj" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/94ce4f54-9a6c-5748-9c1c-f9c7231a4531/42b62845d70a619f063a7da093d995ec8e15e778#package.tar.gz";
    });
    ...
    "packages/OpenSSL_jll/fws6q" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/458c3c95-2e84-50aa-8efc-19380b2a3a95/15003dcb7d8db3c6c857fda14891a539a8f2705a#package.tar.gz";
    });
    ...
    "packages/Preferences/SHSJJ" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/21216c6a-2e73-6563-6e65-726566657250/00cfd92944ca9c760982747e9a1d0d5d86ab1e5a#package.tar.gz";
    });
    ...
    "packages/URIs/o9DQG" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/5c2747f8-b7ea-4ff2-ba2e-563bfd36b1d4/97bbe755a53fe859669cd907f2d96aee8d2c1355#package.tar.gz";
    });
    "packages/XML2_jll/8hNQM" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/package/02c8fc9c-b97f-50b9-bbe4-9be30ff0a78a/1acf5bdf07aa0907e0a37d3718bb88d4b687b74a#package.tar.gz";
    });
    "registries/General" = (pkgs.fetchzip {
      ...
      "stripRoot" = false;
      "url" =
        "https://pkg.julialang.org/registry/23338594-aafe-5451-b93e-139f81909106/71e9e8ceca36d6e97cb61077245a345195b813b0#registry.tar.gz";
    });
  };
}
